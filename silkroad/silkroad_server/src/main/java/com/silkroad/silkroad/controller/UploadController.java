...
public class UploadController {
    ...
    public ResponseEntity<ApiResponse<String>> uploadProfileImage(@RequestParam("file") MultipartFile file, HttpServletRequest request) {
        String imageUrl = fileUploadService.upload(Collections.singletonList(file), "profile", request).get(0);
